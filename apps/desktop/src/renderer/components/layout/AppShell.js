...
export function AppShell() {
    ...
    return (_jsxs("div", { className: "w-full h-full flex flex-col relative", style: { background: "var(--bg-root)" }, children: [_jsx(WelcomeScreen, {}), _jsx(MenuBar, {}), _jsxs("div", { className: "h-9 bg-slate-900/80 border-b border-slate-800 flex items-center px-4 gap-3 flex-shrink-0", children: [_jsx("div", { className: "flex bg-slate-800/40 rounded-lg p-0.5 gap-0.5", children: MODES.map((m) => (_jsx("button", { onClick: () => setMode(m), className: `px-4 py-1 rounded-md text-xs font-medium transition-all duration-300 ${mode === m
                        ...
                        }, children: _jsx("div", { className: "animate-in fade-in slide-in-from-left duration-300", children: panels.problem?.isOpen && _jsx(LeftPanel, {}) }) })), _jsx(CenterPanel, {}), showTeacher && (_jsx("div", { className: "flex-shrink-0 border-l flex flex-col transition-all duration-500 ease-in-out", style: { width: 320, borderColor: "var(--border-primary)", background: "var(--bg-primary)" }, children: _jsx("div", { className: "animate-in fade-in slide-in-from-right duration-300", children: _jsx(TeacherPanel, {}) }) })), showRightPanel && (_jsx("div", { className: "flex-shrink-0 border-l flex flex-col", style: { width: 340, borderColor: "var(--border-primary)", background: "var(--bg-primary)" }, children: panels.analysis?.isOpen && _jsx(RightPanel, {}) }))] }), showBottomDrawer && _jsx(BottomDrawer, {}), _jsx(Timeline, {})] }));
}
