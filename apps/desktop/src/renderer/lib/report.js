...
export function generateMarkdownReport(data, locale) {
    ...
    if (meta.description)
        lines.push(`- **${isZh ? "描述" : "Description"}**: ${meta.description}`);
 ...
 */
export function captureScreenshot(selector = CANVAS_SELECTOR) {
...
export function generateHTMLReport(data, locale) {
 ...
 */
export async function generatePDFReport(data, locale, options) {
 ...
 */
export async function downloadPDFReport(data, locale, filename) {
