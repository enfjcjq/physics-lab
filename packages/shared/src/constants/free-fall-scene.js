export const FREE_FALL_SCENE = {
    ...
    entities: [
        {
            ...
            name: "Ball",
            position: [0, 10, 0],
            properties: { mass: 2.0, radius: 0.2, restitution: 0.6 },
    ...
    forces: [
        {
            id: "gravity_ball_1", type: "gravity", target_entity: "ball_1",
    ...
    constraints: [
        {
            id: "ground_collision", type: "contact", entities: ["ball_1", "ground"],
    ...
    equations: [
        {
            id: "eq_motion", name: "Motion equation",
    ...
    camera_script: [
        { id: "overview", time: 0.0, position: [8, 6, 8], target: [0, 5, 0], fov: 60, description: "Overview" },
        { id: "closeup", time: 1.3, duration: 0.5, position: [3, 3, 3], target: [0, 2, 0], fov: 45, description: "Impact close-up" },
    ],
    ui_controls: [
        { id: "ctrl_mass", parameter: "entities[0].properties.mass", type: "slider", label: "Mass", default_value: 2.0, min: 0.1, max: 10.0, step: 0.1, unit: "kg", group: "Physics" },
        ...
        { id: "ctrl_height", parameter: "entities[0].position[1]", type: "slider", label: "Height", default_value: 10.0, min: 1.0, max: 50.0, step: 0.5, unit: "m", group: "Initial" },
    ],
    knowledge_tags: [
        {
            id: "kp_free_fall", name: "Free Fall", category: "mechanics", level: 2, importance: 1.0,
        ...
        {
            id: "kp_constant_accel", name: "Constant Acceleration", category: "mechanics", level: 1, importance: 0.9,
            prerequisites: ["kp_free_fall"],
            common_mistakes: ["Sign errors with g direction"],
        },
        {
            id: "kp_newton2", name: "Newton's 2nd Law", category: "mechanics", level: 2, importance: 1.0,
            learning_tips: "F = ma is the bridge between forces and motion",
        },
        {
            id: "kp_energy_cons", name: "Energy Conservation", category: "mechanics", level: 2, importance: 0.8,
...
//# sourceMappingURL=free-fall-scene.js.map