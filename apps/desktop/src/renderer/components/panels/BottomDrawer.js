...
function CanvasChart({ activeTab, trail, mass, gravity, height, currentTime }) {
    ...
    return (_jsxs("div", { ref: containerRef, className: "w-full h-full relative", onMouseMove: handleMouseMove, onMouseLeave: handleMouseLeave, children: [_jsx("canvas", { ref: canvasRef, className: "w-full h-full", style: { display: "block" } }), tooltip && (_jsx("div", { className: "absolute pointer-events-none z-10 px-2 py-1 rounded text-[10px] font-mono", style: {
                    left: tooltip.x, top: tooltip.y,
                    background: COLORS.tooltip.bg, border: `1px solid ${COLORS.tooltip.border}`,
                    color: COLORS.tooltip.text,
                }, children: tooltip.text.map((line, i) => _jsx("div", { children: line }, i)) }))] }));
}
