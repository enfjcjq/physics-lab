          ...
          <div className="space-y-4 mb-6">
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50 text-left">
              <div className="flex items-center gap-3 mb-2">
                <span className="w-8 h-8 rounded-lg bg-sky-600/20 flex items-center justify-center text-sky-400">1</span>
            ...
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50 text-left">
              <div className="flex items-center gap-3 mb-2">
                <span className="w-8 h-8 rounded-lg bg-emerald-600/20 flex items-center justify-center text-emerald-400">2</span>
            ...
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50 text-left">
              <div className="flex items-center gap-3 mb-2">
                <span className="w-8 h-8 rounded-lg bg-violet-600/20 flex items-center justify-center text-violet-400">3</span>
