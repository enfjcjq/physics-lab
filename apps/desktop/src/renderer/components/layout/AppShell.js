...
export function AppShell() {
    ...
    return (_jsxs("div", { className: "w-full h-full flex flex-col", style: { background: "var(--bg-root)" }, children: [_jsx(MenuBar, {}), _jsxs("div", { className: "h-9 bg-slate-900/80 border-b border-slate-800 flex items-center px-4 gap-2 flex-shrink-0", children: [_jsx("div", { className: "flex bg-slate-800/60 rounded-lg p-0.5", children: MODES.map((m) => (_jsx("button", { onClick: () => setMode(m), className: `px-4 py-1.5 rounded-md text-xs font-medium transition-all duration-200 ${mode === m
                                ? "bg-sky-600 text-white shadow-md"
                                : "text-slate-400 hover:text-slate-200"}`, children: t(`mode.${m}`) }, m))) }), _jsx("span", { className: "text-[10px] text-slate-600 ml-2", children: t(`mode.${mode}.desc`) })] }), _jsxs("div", { className: "flex-1 flex min-h-0", children: [showLeftPanel && (_jsx("div", { className: "flex-shrink-0 border-r flex flex-col", style: {
                            width: mode === "learning" ? 260 : 280,
                            borderColor: "var(--border-primary)",
                            background: "var(--bg-primary)",
                        }, children: panels.problem?.isOpen && _jsx(LeftPanel, {}) })), _jsx(CenterPanel, {}), showTeacher && (_jsx("div", { className: "flex-shrink-0 border-l flex flex-col", style: {
                            width: 320,
                            borderColor: "var(--border-primary)",
                            background: "var(--bg-primary)",
                        }, children: _jsx(TeacherPanel, {}) })), showRightPanel && (_jsx("div", { className: "flex-shrink-0 border-l flex flex-col", style: {
                            width: 340,
                            borderColor: "var(--border-primary)",
                            background: "var(--bg-primary)",
                        }, children: panels.analysis?.isOpen && _jsx(RightPanel, {}) }))] }), bottomOpen && _jsx(BottomDrawer, {}), _jsx(Timeline, {})] }));
}
